...
/*
 * IMU attitude abstraction.
 * gyro_z is filtered and integrated into yaw; pitch/roll use a simplified
 * accelerometer complementary channel for stability diagnostics.
 */
